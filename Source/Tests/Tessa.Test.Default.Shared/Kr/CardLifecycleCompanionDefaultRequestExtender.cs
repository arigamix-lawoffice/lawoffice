...
{
    /// <summary>
    /// Изменяет запросы выполняемые <see cref="CardLifecycleCompanion{T}"/> устанавливая <see cref="CardRequestBase.ServiceType"/> равным <see cref="CardServiceType.Default"/>.
    /// </summary>
    public class CardLifecycleCompanionDefaultRequestExtender :
        CardLifecycleCompanionRequestExtender
    {
        #region Constants

        private const CardServiceType serviceType = CardServiceType.Default;
