...
namespace Tessa.Extensions.Default.Server.Workflow.KrCompilers.Requests
{
    ...
    /// компиляции для карточек типа <see cref="DefaultCardTypes.KrStageCommonMethodTypeName"/>.
    /// </summary>
    public sealed class KrSourceStageCommonMethodGetExtension :
        KrSourceGetExtensionBase
    {
        ...
        public KrSourceStageCommonMethodGetExtension(
